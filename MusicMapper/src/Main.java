...
/**
 * Main class used to graph bands and connect them based on genre, year
...
public class Main {
	 ...
	 */
	public boolean createGraph() throws IOException {
		...
		FileReader fr;
		fr = new FileReader(
				"/Users/michael/Desktop/CompSci/Courses/Summer 2022/CS 400/MusicMapper/data/metal_bands_2017_updated.csv");
	 ...
	 * @throws Exception if recommendations could not be made.
	 */
	public ArrayList<Band> findRecommendations(String[] input) throws Exception {
		...
		if (paths.size() > 0) {
			...
			// connections first.
			ArrayList<Band> matchingBands = new ArrayList<Band>();
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("An unexpected error occured when loading the data and creating the graph!"
					+ "Please verify that the data is in the correct folder (labelled 'data') and try again");
		}
		...
		// Getting an arrayList of recommendations, sorted by weight.
		try {
